<script lang="ts">
	...
	import { createCustomer } from '$svc/customers/customers.service';
	...
	let { isOpen = $bindable(), onClose, onLoadData }: ModalProps = $props();
...
<Dialog.Root bind:open={isOpen} onOpenChange={handleOpenChange}>
	<Dialog.Content class="max-w-md">
		<Dialog.Header>
			...
			<Dialog.Description>Create a new customer for your laundry service.</Dialog.Description>
		</Dialog.Header>
