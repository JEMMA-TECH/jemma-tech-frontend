...
<Sidebar class="h-screen w-80 bg-white dark:bg-gray-800 shadow-md">
    <SidebarWrapper class="flex flex-col h-full">
      <SidebarGroup>
        ...
        <SidebarItem label="Orders" href="/orders">
          ...
          <svelte:fragment slot="subtext">
            <span class="inline-flex justify-center items-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300"> 3 </span>
          </svelte:fragment>
        </SidebarItem>
        ...
        <SidebarItem label="Payments" href="/payments">
          <svelte:fragment slot="icon">
            <ChartMixedDollarSolid class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
          </svelte:fragment>
        </SidebarItem>
      ...
      <SidebarGroup border>
        ...
        <SidebarItem label="Company Info" href="/company">
          <svelte:fragment slot="icon">
        ...
        <SidebarItem label="Sign Out" href="/login">
            <svelte:fragment slot="icon">
